...
export const actionViewProduct = "action/VIEW_PRODUCT_CONTENT";
export const actionUpdateViewProduct = "action/UPDATE_VIEW_PRODUCT";
export const actionViewTransactionId = "action/VIEW_TRANSACTION_ID";
...
export const updateAllproductDatas = (payLoad) => {
    return (dispatch, getState) => {
      dispatch ({
        type: actionViewProduct,
        payLoad,
      });
    };
  };

  export const updateViewProductData = (payLoad) => {
    return (dispatch, getState) => {
      dispatch({
        type: actionUpdateViewProduct,
        payLoad,
      });
    };
  };

  export const updateViewTransactionId = (payLoad) => {
    return (dispatch, getState) => {
      dispatch({
        type: actionViewTransactionId,
        payLoad,
      });
    };
  };

export const updateProductContent = (payLoad) => {
    return (dispatch, getState) => {
      dispatch ({
        type: actionViewProduct,
        payLoad,
