...
const Servicecomponent = (props) => {
  ...
  const [serviceTypes, setServiceTypes] = useState([
    {
      serviceType: "User Profiles",
      serviceTypeId: "user_profiles",
      serviceIcon: "school",
      fontSize: 28,
    },
    {
      serviceType: "User Permissions",
      serviceTypeId: "user_permissions",
      serviceIcon: "military_tech",
      fontSize: "28",
    },
    {
      serviceType: "Course Catelogue",
      serviceTypeId: "course_catelogue",
      serviceIcon: "history_edu",
      fontSize: "28",
    },
    {
      serviceType: "Package",
      serviceTypeId: "package",
      serviceIcon: "location_city",
      fontSize: "28",
    },
    {
      serviceType: "Grouping",
      serviceTypeId: "grouping",
      serviceIcon: "location_city",
      fontSize: "28",
    },
    {
      serviceType: "Broad cast",
      serviceTypeId: "broad_cast",
      serviceIcon: "location_city",
      fontSize: "28",
    },
    {
      serviceType: "Review Items",
      serviceTypeId: "review_items",
      serviceIcon: "location_city",
      fontSize: "28",
    },
    {
      serviceType: "Certificate",
      serviceTypeId: "certificate",
      serviceIcon: "location_city",
      fontSize: "28",
    },
    {
